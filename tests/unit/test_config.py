...
def test_validate_config(sample_config_path, test_env_vars):  # Added test_env_vars
    ...
    config.email_recipients = {"John Doe": ["john@example.com"]}  # Set directly for this test
...
def test_environment_variables(sample_config_path, test_env_vars):
    ...
    assert config.email_recipients["John Doe"] == ["john@example.com", "john.sales@example.com"]
